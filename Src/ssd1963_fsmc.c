...
const unsigned char array_tiny_8x8[][8] = {
...
//	HAL_Delay(500);
	...
	LCD_String_Font(10, 2, BLACK, RED, segment_sixteen_64x96_num, array);
		
//	sprintf(array, "0123456789");
//	const uint8_t string_1 [] = "012345";
		LCD_String(10, 300, BLUE, BLACK, *array_tiny_8x8, "1234567890: TEST", 1, 8, 8);
